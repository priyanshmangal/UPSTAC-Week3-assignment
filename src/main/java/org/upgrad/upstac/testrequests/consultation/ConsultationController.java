...
public class ConsultationController {
    ...
    public List<TestRequest> getForDoctor()  {
        ...
        try {
            ...
            List<TestRequest> result =  testRequestQueryService.findByDoctor(user);
            return result;
    ...
    public TestRequest updateConsultation(@PathVariable Long id,
        ...
        try {
            User tester=userLoggedInService.getLoggedInUser();
            return testRequestUpdateService.updateConsultation(id, createConsultationRequest, tester);
